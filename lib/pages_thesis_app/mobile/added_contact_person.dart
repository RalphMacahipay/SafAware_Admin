...
class ContactPersonAdded extends StatefulWidget {
  const ContactPersonAdded({super.key});

  @override
  State<ContactPersonAdded> createState() => _ContactPersonAddedState();
}

class _ContactPersonAddedState extends State<ContactPersonAdded> {
  ...
  late final TextEditingController myNameControlller;
  ...
  void initState() {
    ...
    myNameControlller = TextEditingController();
